...
imprima a mensagem "Aluno reprovado.". Se a média calculada for um valor entre 5.0 e 6.9, inclusive estas, o programa deve 
...
def main():
    # Solicitando e lendo as quatro notas uma por uma
    ...
    # Calculando a média ponderada com pesos 2, 3, 4 e 1
